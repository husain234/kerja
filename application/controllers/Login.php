...
class Login extends CI_Controller {
    ...
    {
        parent::__construct();
        $this->load->model(array('Mod_poli', 'Mod_berkas', 'Mod_login'));
    ...
    {
        $total = $this->Mod_poli->totalRows('poli');
        $config['base_url']   = base_url('login/view_poli/');
        ...
        $data['poli']    = $this->Mod_poli->getDataPoli($limit, $offset);
        $data['title']      = 'Data Poli';

        // $data['poli'] = $this->Mod_poli->getAll()->result();
        $this->load->view('formlogin/view_poli', $data);
    }

    public function search_poli()
    {
        $total = $this->Mod_poli->totalRows('poli');
        $config['base_url']   = base_url('login/search_poli/');
        $config['total_rows'] = $total;
        $config['per_page']   = 5;
       ...
       $cari = $this->input->post('cari_poli');
       $data['title']   = 'Data Poli';
       $data['poli'] = $this->Mod_poli->searchPoli($cari, $limit, $offset);
       $this->load->view('formlogin/view_poli', $data);
    }

    public function search_berkas()
    {
        $total = $this->Mod_berkas->totalRows('berkas');
        $config['base_url']   = base_url('login/search_berkas/');
        $config['total_rows'] = $total;
        $config['per_page']   = 5;
        ...
        $cari = $this->input->post('cari_berkas');
        $data['title']   = 'Data Berkas';
        $data['berkas'] = $this->Mod_berkas->searchBerkas($cari, $limit, $offset);
        $this->load->view('formlogin/view_berkas', $data);
    }
