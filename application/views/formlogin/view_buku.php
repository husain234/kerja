    ...
    <div class="col-md-8 ">
        ...
        <table class="table table-striped table-bordered table-hover">
            ...
            <tr>
                <td><?php echo $no;?></td>
                <td><?php if($row->image != "") { ?>
                    <img src="<?php echo base_url('assets/img/berkas/'.$row->image);?>" width="100px" height="100px">
                <?php }else{ ?>
                    <img src="<?php echo base_url('assets/img/berkas/book-default.jpg');?>" width="100px" height="100px">
                <?php } ?> 
                </td>
