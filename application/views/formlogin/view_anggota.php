    ...
    <div class="navbar navbar-default">
        ...
        <div class="navbar-collapse collapse">
            ...
            <div class="nav navbar-nav navbar-right">
                <form class="navbar-form navbar-right" role="search" action="<?php echo site_url('login/search_poli');?>" method="post">
                    <div class="form-group">
                        <input type="text" name="cari_poli" class="form-control" placeholder="Search Member">
                    </div>
    ...
    <div class="col-md-8 ">
        ...
        <table class="table table-striped table-bordered table-hover">
            ...
            <tr>
                <td><?php echo $no;?></td>
                <td><?php if($row->image != "") { ?>
                    <img src="<?php echo base_url('assets/img/poli/'.$row->image);?>" width="100px" height="100px">
                <?php }else{ ?>
                    <img src="<?php echo base_url('assets/img/poli/images.jpg');?>" width="100px" height="100px">
                <?php } ?> 
                </td>
